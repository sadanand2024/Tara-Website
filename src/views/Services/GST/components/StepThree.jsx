    ...
    const fetchReviewAndFilingData = async () => {
      try {
        ...
        if (res?.res?.status_cd === 0) {
          ...
          const reviewSection = taskData?.['GST Review Filing Certificate'];
                ...
                {idx === 0 && (
                  ...
                  >
                        ...
                        <input
                          ...
                          onChange={async (e) => {
                            ...
                            let urlEndpoint = reviewAndFiling?.data?.id
                              ? `/gst/gst-review-filing-certificate/${reviewAndFiling?.data?.id}/`
                              : '/gst/gst-review-filing-certificate/';
                    ...
                    <Box display="flex" justifyContent="flex-start" gap={1}>
                      <GetActionButtons
                        type="put"
                        urlEndpoint="gst-review-filing-certificate"
