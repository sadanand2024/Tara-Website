...
const BasicBusinessInfo = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      is: (val) =>
      ['Foreign Company', 'Private Comapny', 'Public Company', 'One Person Company','Section 8 Company'].includes(val),
    ...
    onSubmit: async (values) => {
      ...
      formData.append('service_task', 66);
  ...
  const getbasicInfo = async () => {
    const url = `/gst/basic-business-info/by-service-request/?service_request_id=32`;
      ...
      <Card sx={{ p: 3 }}>
        <form onSubmit={handleSubmit}>
          <Grid2 container spacing={2}>
            ...
            {['Foreign Company', 'Private Comapny', 'Public Company', 'One Person Company','Section 8 Company'].includes(values.constitution_of_business) && (
              <>
