...
export default function HashtagsCard({ title, blogData, showAcceptButton }) {
...
HashtagsCard.propTypes = { title: PropTypes.string, blogData: PropTypes.array, showAcceptButton: PropTypes.bool };
