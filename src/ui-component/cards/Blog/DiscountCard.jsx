...
export default function DiscountCard({ discountText, description, buttonText }) {
...
DiscountCard.propTypes = { discountText: PropTypes.string, description: PropTypes.string, buttonText: PropTypes.string };
