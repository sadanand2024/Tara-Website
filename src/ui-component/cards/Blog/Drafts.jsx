...
export default function Drafts({ title, avatarCount, draftData }) {
...
Drafts.propTypes = { title: PropTypes.string, avatarCount: PropTypes.number, draftData: PropTypes.array };
